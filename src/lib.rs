...
#![test_runner(no_std_tester::my_runner)]
#![feature(llvm_asm)]
...
extern "C" fn sample_main() {
    test_main();
    nanos_sdk::exit_app(42);
}

#[cfg(test)]
mod tests {
    use super::*;
    use no_std_tester::{dbg, println, print, assert_eq_v, TestType};
    use testmacro::test_item;
...
pub fn handle_apdu(comm: &mut io::Comm) -> Result<(), io::StatusWords> {
    if comm.rx == 0 {
